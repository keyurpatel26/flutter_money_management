...
class ExpensesAddDetailsWidget extends StatefulWidget {
  const ExpensesAddDetailsWidget({super.key});
  @override
  State<ExpensesAddDetailsWidget> createState() => _ExpensesAddDetailsWidgetState();
}

class _ExpensesAddDetailsWidgetState extends State<ExpensesAddDetailsWidget> {
  ...
  String? selctedItem;
  late double totaleamount, totalexpense;
            ...
            await FirebaseFirestore.instance.collection('users').doc(FirebaseAuth.instance.currentUser!.uid).update(
              {
                ...
                'totalexpense': totalexpense + double.parse(amountCon.text),
              },
            );
  ...
  Widget amount() {
    return TextFieldWidget(textCapitalization: TextCapitalization.words,
      ...
      child: Padding(
        ...
        child: DropdownButtonFormField<String>(
          ...
          items: expenseitems
              ...
              .toList(),
          selectedItemBuilder: (BuildContext context) => expenseitems
              .map((e) => Row(
                    children: [
